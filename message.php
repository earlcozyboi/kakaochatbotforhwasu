<?php
    ...
    switch($content)
    {
            ...
            echo '
                {
                    "message":
                    {
                        "text": "안녕하세요 화수고 급식 알림이입니다!\n\n오류 발생시 언제든지 31127 이현수에게 문의주세요!\\n\\nMIT 라이센스에 따라 이용이 가능합니다.\\n\\n2018 화수고등학교 자율동아리 코드블록"
                    },
                    "keyboard":
                    {
                        "type": "buttons",
		...
		case "오늘 급식":
			$lunch = get_lunch_today("J100000868");
            echo '
                {
                    "message":
                    {
		...
		case "내일 급식":
			$lunch = get_lunch_tomorrow("J100000868");
            echo '
                {
                    "message":
                    {
		...
		case "이달 급식":
			$lunch = get_lunch_month("J100000868");
            echo '
                {
                    "message":
                    {
